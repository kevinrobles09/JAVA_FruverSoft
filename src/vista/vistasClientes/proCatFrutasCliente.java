 ...
 * @author MECO
 */
public class proCatFrutasCliente extends javax.swing.JFrame {
   
    /**
     * Creates new form vistaPrincipal
     */
    public proCatFrutasCliente() {
        initComponents();
       ...
       jt_cate_productos.setModel(modelo);
        ...
        String sql="SELECT proNombre, proVencimiento, prodPrecio, uniDenominacion, claDenominacion\n" +
                    ...
                    "WHERE claDenominacion LIKE '%frutas%'";
    ...
    private void btnRegresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegresarMouseClicked
        productosVistaPrincipalCliente regresar = new productosVistaPrincipalCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proCatFrutasCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proCatFrutasCliente().setVisible(true);
                //productos_categorias vv =new proCatFrutasCliente();
                // vv.verCategoria ();
            }
        });
    }
