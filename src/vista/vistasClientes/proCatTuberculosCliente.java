 ...
 * @author MECO
 */
public class proCatTuberculosCliente extends javax.swing.JFrame {
   
    /**
     * Creates new form vistaPrincipal
     */
    public proCatTuberculosCliente() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proCatTuberculosCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proCatTuberculosCliente().setVisible(true);
