 ...
 * @author MECO
 */
public class proCatGranosCliente extends javax.swing.JFrame {
   
    /**
     * Creates new form vistaPrincipal
     */
    public proCatGranosCliente() {
        initComponents();
       ...
       jt_cate_productos.setModel(modelo);
        ...
        String sql="SELECT proNombre, proVencimiento, prodPrecio, uniDenominacion, claDenominacion\n" +
                    ...
                    "WHERE claDenominacion LIKE '%granos%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proCatGranosCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proCatGranosCliente().setVisible(true);
