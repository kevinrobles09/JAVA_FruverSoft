 ...
 * @author MECO
 */
public class proBusGeneralCliente extends javax.swing.JFrame {
   
    /**
     * Creates new form vistaPrincipal
     */
    public proBusGeneralCliente() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proBusGeneralCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proBusGeneralCliente().setVisible(true);
