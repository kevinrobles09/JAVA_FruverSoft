 ...
 * @author MECO
 */
public class proCatVerdurasCliente extends javax.swing.JFrame {
   
    /**
     * Creates new form vistaPrincipal
     */
    public proCatVerdurasCliente() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proCatVerdurasCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proCatVerdurasCliente().setVisible(true);
